...
function M.get(c, options)
  ...
  return {
    ...
    Normal                      = { fg = c.base4, bg = options.transparent and c.none or c.bg }, -- normal text
    NormalNC                    = { fg = c.base4, bg = options.transparent and c.none or options.dim_inactive and c.base04 or c.bg }, -- normal text in non-current windows
    NormalSB                    = { fg = c.base4, bg = c.bg_sidebar }, -- normal text in sidebar
    NormalFloat                 = { fg = c.base4, bg = c.bg_float }, -- Normal text in floating windows.
